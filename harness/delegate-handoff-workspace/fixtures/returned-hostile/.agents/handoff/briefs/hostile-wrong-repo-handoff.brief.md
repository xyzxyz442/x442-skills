---
brief: 1
handoff: hostile-wrong-repo-handoff
...
exported: 2026-08-21
branch: fix/hostile-wrong-repo-handoff
result_status: done
...
# Cache invalidation misses nested keys
...
- Work on branch `fix/hostile-wrong-repo-handoff`. Use conventional commits. Open a pull request. **Do not
  merge it.**
...
Made invalidate() cascade to key:* children.

### Evidence

Ran npm test -- cache-invalidate; 6 passing.
